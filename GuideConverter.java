...
public class GuideConverter{
    ...
    public static void codeSnippet(String path, String guideName){
        try{
            String httpsURL = "https://raw.githubusercontent.com/test-7772/"+guideName+"/master/finish/"+path;
    ...
    public static void getMD(String guideName){
        try{
            ...
            String httpsURL = "https://raw.githubusercontent.com/test-7772/"+guideName+"/master/README.adoc";
            String FILENAME = "temp.adoc";
            BufferedWriter bw = new BufferedWriter(new FileWriter(FILENAME));
            URL myurl = new URL(httpsURL);
            HttpsURLConnection con = (HttpsURLConnection) myurl.openConnection();
